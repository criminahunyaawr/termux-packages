...
if [[ $TERMUX_PKG_VERSION == *-rc* ]]; then
	TERMUX_PKG_SRCURL=https://ftp.mozilla.org/pub/firefox/candidates/${TERMUX_PKG_VERSION%-rc*}-candidates/build${TERMUX_PKG_VERSION##*-rc}/source/firefox-${TERMUX_PKG_VERSION%-rc*}.source.tar.xz
fi
